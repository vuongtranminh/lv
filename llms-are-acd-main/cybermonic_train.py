...
from CybORG.Agents.CybermonicAgents.cage4 import InductiveGraphPPOAgent
from CybORG.Agents.CybermonicAgents.memory_buffer import MultiPPOMemory
...
if __name__ == '__main__':
    ...
    ap.add_argument(
        "--wandb-mode", type=str, default="offline", help="Mode for wandb logging (offline, online)"
    )
    ap.add_argument("--wandb-entity", type=str, default="defaultuser-ucsc", help="Wandb user name to log project.")
    ap.add_argument("--experiment-name", type=str, default="train", help="Name of experiment.")

    args = ap.parse_args()
    print(args)

    project_name = "cybermonic"

    wandb.init(name=args.experiment_name, entity=args.wandb_entity, project=project_name, mode=args.wandb_mode)
    ...
    wandb.log({"train_time": time_elapsed_minutes})

    print(f"Training time: {time_elapsed_minutes}")