...
SETUPS = {
    "A": {"mcp_enabled": False, "roe_enabled": False, "label": "baseline_TH3"},
    "B": {"mcp_enabled": True,  "roe_enabled": False, "label": "MCP_only"},
    "C": {"mcp_enabled": True,  "roe_enabled": True,  "label": "MCP_RoE"},
}
